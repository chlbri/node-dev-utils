            ...
            test: {
              ...
              coverage: {
                ...
                include: [
                  ...
                  'src/rolldown-config/plugins/typescript.fast.ts',
                  'src/rolldown-config/plugins/typescript.ts',
                  'src/rolldown-config/types.ts',
                  'src/utils/array.ts',
                  'src/utils/bemedev/globals/types.ts',
                  'src/utils/bemedev/globals/utils/_unknown.ts',
                  'src/utils/bemedev/globals/utils/expandFn.ts',
