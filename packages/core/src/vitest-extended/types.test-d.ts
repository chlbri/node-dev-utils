...
expectTypeOf<FN1>().toEqualTypeOf<{ parameters?: string | Params1 }>();
// #endregion
...
expectTypeOf<FN2>().toEqualTypeOf<{ parameters?: never }>();
// #endregion
...
expectTypeOf<FN3>().toEqualTypeOf<{ parameters?: boolean | Params3 }>();
// #endregion
...
expectTypeOf<FN4>().toEqualTypeOf<{ parameters?: object | Params4 }>();
// #endregion
...
expectTypeOf<FN5>().toEqualTypeOf<{ parameters?: string | Params5 }>();
// #endregion
...
expectTypeOf<FN6>().toEqualTypeOf<{ parameters?: string | Params5 }>();
// #endregion
